...
void* sendMessage(void* args) {
    ...
    char* serviceReturnMsg = params->serviceMsg;
...
void* handleReceivedMessage(void* args) {
    ThreadParams* params = (ThreadParams*)args;
    int clientFd = params->clientFd;
...
void client(int port) {
    ...
    ThreadParams params = {clientInput, client_fd, serviceMsg, matrix, &score};
